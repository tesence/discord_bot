...
VARIATIONS = { v.lower() : v for v in ["0XP", "NonProgressMapStones", "Entrance", "ForceMapStones", 
		"ForceRandomEscape", "ForceTrees", "Hard", "NoPlants", "NoTeleporters", "OHKO", "Starved", "BonusPickups"]}
...
class OriRandomizerAPIClient(base.APIClient):
    ...
    async def get_data(self, seed, preset, key_mode=None, path_diff=None, varations=[], logic_paths=[], flags=[]):
        ...
        if preset in PRESET_VARS:
            varations = set(varations + PRESET_VARS[preset])
